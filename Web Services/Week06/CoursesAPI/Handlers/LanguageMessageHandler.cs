...
namespace CoursesAPI
{
    public class LanguageMessageHandler : DelegatingHandler
    {
        ...
        private readonly List<string> _supportedLanguages = new List<string> { Langis, LangenUS, };
        ...
        {
            var r = request.Headers.AcceptLanguage.ToString();
